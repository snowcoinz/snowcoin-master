...
// snowcoin: attempt to generate suitable proof-of-stake
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "SNOWCOIN - THE NORTH REMEMBERS";
        CTransaction txNew;
        txNew.nTime = 1500655976;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x1fdd1a2804172498a3eedcfea803b6ee1232f1266be4d92c686b73a7900f440a"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xf1, 0xf2, 0xd3, 0xf4 };
